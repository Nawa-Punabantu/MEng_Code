...
def get_data_from_excel(file_path, resolution):
    ...
    feed_conc_borate = df.iloc[0]['glucose conc in slug (g/cm^3)']
    
    feed_conc_hcl = df.iloc[0]['fructose conc in slug (g/cm^3)']
    ...
    col_elution_data_borate = df.iloc[t_start:t_end]['glucose g/cm^3']
    
    col_elution_data_hcl = df.iloc[t_start:t_end]['fructose g/cm^3']
...
if __name__ == "__main__":
    ...
    file_path_glu_fru = r"C:\Users\28820169\Downloads\BO_Papers\MEng_Code\case2_Glu-Fru\glu_fru_launch.xlsx"




    # --------------------------------
    t_data, col_elution_data, column_func_inputs = get_data_from_excel(file_path_glu_fru, resolution=None)
    num_points = len(t_data)
